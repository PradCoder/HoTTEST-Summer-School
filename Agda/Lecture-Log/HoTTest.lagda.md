...
```
In practice (exercises and projects) it is hard to convince agda to show 
that recursive definitions terminate
Homotopy type theory is done in MLTT, it doesn't have recursive defintions
...
When you define type you need to define defintional equality.
Try to do things in MLTT to understand

```
-- eliminator principal for lists
-- check notes
